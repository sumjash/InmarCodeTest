...
{
  public class GetCustomApplicationExceptionOnSingleResourceUpdate : IApiOperation<DiagnosticEntity>
  {
    public DiagnosticEntity Run(IUnitOfWork unitOfWork)
    {    
      throw new CustomApplicationException<DiagnosticError>(DiagnosticError.DiagnosticErrorFromSingleResourceUpdate);
    }
  }
}