...
{
  public class GetCustomApplicationExceptionOnSingleResourceReadOperationCoordinator :
    OperationsCoordinatorReadSingle<DiagnosticEntity, DiagnosticResource, DiagnosticsMapper>
  {
    ...
    {
      var operation = DiagnosticApiOperationFactory.CreateCustomApplicationExceptionOnSingleResourceRead();
      return operation;
    }
  }
}