...
{
  public class GetDiagnosticExceptionOnSingleResourceDeleteOperationCoordinator :
    OperationsCoordinatorDeleteSingle<DiagnosticEntity, DiagnosticResource, DiagnosticsMapper>
  {
    ...
    {
      var operation = DiagnosticApiOperationFactory.CreateDiagnosticExceptionOnSingleResourceDelete();
      return operation;
    }
  }
}